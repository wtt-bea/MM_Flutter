...
class _NoisePlayerState extends State<NoisePlayer>
          ...
          children: [
            ...
            SizedBox(
              ...
              child: RotationTransition(
                  ...
                  child: CircleAvatar(
                    backgroundImage:
                        AssetImage("lib/assets/noise/images/$_index.png"),
                  )),
            )
          ],
        ));
  ...
  Widget _musicName() {
    return SizedBox(
      child: Text(
        musicName[_index],
        style: TextStyle(
            color: _whiteColor, fontSize: 30, fontWeight: FontWeight.w600),
      ),
    );
  }
  ...
  _play() async {
    audioPlayer.audioCache.prefix = 'lib/assets/noise/music/';
