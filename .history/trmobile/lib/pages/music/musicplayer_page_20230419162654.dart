  ...
  void initState() {
    ...
    streams = <StreamSubscription>[
      ...
      audioPlayer.onPlayerStateChanged.listen((it) {
        ...
        if (streamState == PlayerState.stopped) {
          ...
          Row(children: [
            ...
            Container(
              ...
              child: IconButton(
                ...
                icon: flag == 1
                    ? Icon(Icons.pause_rounded, size: 35, color: _blackColor)
            ...
            Container(
              ...
              child: IconButton(
                onPressed: () {},
                icon:
                    Icon(Icons.skip_next_rounded, size: 28, color: _blackColor),
              ),
            )
          ]),
        ],
