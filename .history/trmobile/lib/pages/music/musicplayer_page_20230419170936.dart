...
class _MusicPlayerState extends State<MusicPlayer>
  ...
  Map musicName = {
    ...
    2: "Time to love",
    3: "Quiet",
    4: "Merry Christmas Mr_ Lawrence",
    5: "Shelter",
    6: "nop",
    7: "Windy Hill",
    8: "City of skyity of sky(Piano)",
    9: "The street where the wind lives(Erhu)",
    10: "Tenten's Theme",
    11: "Eternity in Moments(Piano)",
    12: "Tide chirping"
  };
  ...
  _play() async {
    ...
    await audioPlayer.play(AssetSource('${musicName[widget.index][0]}.mp3'));
