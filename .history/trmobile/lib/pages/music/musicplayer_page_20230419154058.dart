...
class _MusicPlayerState extends State<MusicPlayer>
  ...
  void initState() {
    ...
    streams = <StreamSubscription>[
      audioPlayer.onDurationChanged.listen((it) => setState(() {
            streamDuration = it;
          })),
              ...
              if (duration != null)
                SizedBox(
                  ...
                  child: Slider(
                      ...
                      min: 0.0,
                      max: _duration.inMilliseconds.toDouble())!=null? _duration.inMilliseconds.toDouble()):0.0,
                ),
            ]),
          ),
          // if (position != null)
  ...
  _play() async {
    ...
    await audioPlayer.getDuration().then(
          (value) => setState(() {
            duration = value;
          }),
        );
