              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "社区",
                    style: TextStyle(
                        color: flag_6 ? whiteColor : pinkColor, fontSize: 11),
                  ),
                ],
              ),
              onPressed: () {
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "助眠",
                    style: TextStyle(
                        color: flag_7 ? whiteColor : pinkColor, fontSize: 11),
                  ),
                ],
              ),
              onPressed: () {
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "焦虑星",
                    style: TextStyle(
                        color: flag_8 ? whiteColor : pinkColor, fontSize: 11),
                  ),
                ],
              ),
              onPressed: () {
              ...
              child: Column(
                children: [
                  Icon(
                    ...
                    color: flag_5 ? whiteColor : pinkColor,
                  ),
                  Text(
                    "焦虑星",
                    style: TextStyle(
                        color: flag_5 ? whiteColor : pinkColor, fontSize: 11),
                  ),
                ],
              ),
              onPressed: () {
