                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                width: 30,
                                decoration: const BoxDecoration(
                                    color: Color.fromARGB(255, 255, 242, 64)),
                                child: Column(children: [
                                  Container(
                                    height: 33,
                                    decoration: const BoxDecoration(
                                        color:
                                            Color.fromARGB(255, 149, 97, 54)),
                                  ),
                                  Container(
                                    height: 22,
                                    decoration: const BoxDecoration(
                                        color:
                                            Color.fromARGB(255, 68, 149, 54)),
                                    child: Icon(
                                      const IconData(
                                        0xe601,
                                        fontFamily: "MyIcons",
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    width: 30,
                                    decoration: const BoxDecoration(
                                      color: Color.fromARGB(255, 255, 64, 245),
                                    ),
                                    child: const Icon(
                                      IconData(
                                        0xe616,
