...
import '../../util/ScreenAdapter.dart';
import '../../util/PictureUtils.dart';
import '../../model/ImageBean.dart';
...
class _CommunityPageState extends State<CommunityPage> {
  ...
  Future showBottomSheet() async {
    ...
    builder: (context) {
      ...
      decoration: BoxDecoration(color: Color.fromARGB(255, 117, 184, 46)),
      child: Column(
        children: [
          SizedBox(
            height: 50,
          ...
          Container(
            height: 234,
            decoration:
                BoxDecoration(color: Color.fromARGB(255, 215, 177, 101)),
            child: Column(
              children: [
                DragSortView(
                  _imageList,
...
buildBottomSheetWidget(BuildContext context) {
